    ...
    <>
        ...
        <div className="grid-container first" style={{ overflow: "hidden" }}>
          ...
          <div className="left-column">
            <div className="left-column top">
              <div style={{ color: "lightgreen", fontSize: 18 }}>
                Into the void
              </div>
          ...
          <div className="middle-column top">
            ...
            >
              ...
              <div>
                ...
                >
                  <div className="typewriter albumname">08:19 27</div>
                  <div className="typewriter artistname">Way Out</div>
                  <div
                    style={{
                      marginTop: "30%",
                      display: "flex",
      ...
      <div className="hero">
        <div className="grid-container">
          ...
          <div className="middle-column-video">
        <div className="herotitle" style={{ marginTop: "5vh" }}>
                  MUSIC VIDEO
                </div>
                ...
                >
                  <iframe
                    width="95%"
                    height="70%"
                    src="https://www.youtube.com/embed/29uruM5-VYo"
          ...
          <div className="middle-column bottom">
            <div className="footer-middle-grid">
              <div className="footerlinks">
                <div className="footer-middle-grid-inner">
                  <div>About</div>
                  <div>Way out</div>
                  <div>Contact us</div>
                  <div>Careers</div>
              ...
              <div className="footer-middle-grid-inner">
                <div className="footerlinks">
                  ...
                  <div style={{ letterSpacing: "3px" }}>Privacy policy</div>
                </div>
              </div>

              <div className="footer-news">
                <div className="footerlinks" style={{ color: "grey" }}>
                  Way out news
                </div>
                <div
                  style={{
                ...
                >
                  Don&apos;t miss a thing stay up to date with the latest news
                  from us.
                </div>
                <div>
      ...
      <div className="belowfooter">
        <div className="grid-container">
          <div className="left-column"></div>
          <div className="belowfooter-middle">
            <div
              style={{ color: "white", fontSize: "16px", letterSpacing: "3px" }}
            >
              2011 - 2023 Way Out, All Rights Reserved
            </div>
