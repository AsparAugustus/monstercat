  ...
  return (
        ...
        <div className="middle-column">
          <div className="grid-container hero">
            <div>
              ...
              <div className="herotitle" style={{ "marginTop": "5vh"}}>MUSIC VIDEO</div>
              
              <div style={{"position" : "absolute", "width" : "85vw", "height" : "60vw"}}>
    ...
    <div className="footer">
      ...
      <div style={{"color" : "white", "fontSize" : "16px", "letterSpacing" : "3px"}}>
       ...
       <div style={{"display" : "flex", "justifyContent" : "flex-start", "fill" : '#fff', "gap" : "14px"}}>
